...
//         &'a mut self,
//         request: Request,
//     ) -> Pin<Box<dyn Future<Output = Result<(), SubxtClientError>> + Send + 'a>> {
//         Box::pin(async move {
...
//     fn next_response<'a>(
//         &'a mut self,
//     ) -> Pin<Box<dyn Future<Output = Result<Response, SubxtClientError>> + Send + 'a>>
//     {
//         Box::pin(async move {
//             let response = self
//                 .from_back
